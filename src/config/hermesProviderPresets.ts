/**
 * Hermes provider presets configuration
 * Hermes uses models.providers structure with custom provider configs
 */
import type {
  ProviderCategory,
...
export interface HermesProviderPreset {
  ...
  websiteUrl: string;
  apiKeyUrl?: string;
  /** Hermes settings_config structure */
  settingsConfig: HermesProviderConfig;
  isOfficial?: boolean;
  isPartner?: boolean;
...
/**
 * Hermes API protocol options
 * @see https://github.com/hermes/hermes/blob/main/docs/gateway/configuration.md
 */
export const hermesApiProtocols = [
