...
import { hermesApiProtocols } from "@/config/hermesProviderPresets";
import type { ProviderCategory, HermesModel } from "@/types";
  ...
  return (
    <>
      ...
      <div className="space-y-2">
        <FormLabel htmlFor="hermes-api">
          {t("hermes.apiProtocol", {
            defaultValue: "API 协议",
          })}
        </FormLabel>
        <Select value={api} onValueChange={onApiChange}>
          <SelectTrigger id="hermes-api">
            <SelectValue
              placeholder={t("hermes.selectProtocol", {
                defaultValue: "选择 API 协议",
              })}
            />
          </SelectTrigger>
          <SelectContent>
            {hermesApiProtocols.map((protocol) => (
      ...
      <div className="space-y-2">
        <FormLabel htmlFor="hermes-baseurl">
          {t("hermes.baseUrl", { defaultValue: "API 端点" })}
        </FormLabel>
        <Input
          id="hermes-baseurl"
          value={baseUrl}
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-0.5">
          <FormLabel>
            {t("hermes.userAgent", { defaultValue: "发送 User-Agent" })}
          </FormLabel>
          <p className="text-xs text-muted-foreground">
            {t("hermes.userAgentHint", {
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <FormLabel>
            {t("hermes.models", { defaultValue: "模型列表" })}
          </FormLabel>
          <div className="flex gap-1">
            ...
            >
              ...
              {t("hermes.addModel", { defaultValue: "添加模型" })}
            </Button>
          </div>
        </div>
            ...
            {models.map((model, index) => (
              ...
              >
                ...
                <div className="flex items-center">
                  ...
                  >
                    {index === 0
                      ? t("hermes.primaryModel", {
                          defaultValue: "默认模型",
                        })
                      : t("hermes.fallbackModel", {
                          defaultValue: "回退模型",
                        })}
                  </span>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <div className="flex-1 space-y-1">
                    <label className="text-xs text-muted-foreground">
                      {t("hermes.modelId", { defaultValue: "模型 ID" })}
                    </label>
                    <div className="flex gap-1">
                      <Input
                        value={model.id}
                        ...
                        placeholder={t("hermes.modelIdPlaceholder", {
                  ...
                  <div className="flex-1 space-y-1">
                    <label className="text-xs text-muted-foreground">
                      {t("hermes.modelName", { defaultValue: "显示名称" })}
                    </label>
                    <Input
                      value={model.name}
                      onChange={(e) =>
                      ...
                      placeholder={t("hermes.modelNamePlaceholder", {
                        defaultValue: "Claude 3 Sonnet",
                      })}
                    />
                  </div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex-1 space-y-1">
                        ...
                        <div className="flex items-center h-9 gap-2">
                          ...
                          <span className="text-xs text-muted-foreground">
                            {model.reasoning
                              ? t("hermes.reasoningOn", {
                                  defaultValue: "启用",
                                })
                              : t("hermes.reasoningOff", {
                                  defaultValue: "关闭",
                                })}
                          </span>
                        </div>
                      ...
                      <div className="flex-1 space-y-1">
                        ...
                        {/* "text" is checked by default but can be unchecked —
                            ...
                            Hermes works fine with an empty or image-only array. */}
