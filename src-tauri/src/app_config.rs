...
impl McpApps {
    ...
    pub fn is_enabled_for(&self, app: &AppType) -> bool {
        match app {
            ...
            AppType::Hermes => false, // Hermes doesn't support MCP
        }
    }
    ...
    pub fn set_enabled_for(&mut self, app: &AppType, enabled: bool) {
        match app {
            ...
            AppType::Hermes => {} // Hermes doesn't support MCP, ignore
        }
    }
...
impl SkillApps {
    ...
    pub fn is_enabled_for(&self, app: &AppType) -> bool {
        match app {
            ...
            AppType::Hermes => false, // Hermes doesn't support Skills
        }
    }
    ...
    pub fn set_enabled_for(&mut self, app: &AppType, enabled: bool) {
        match app {
            ...
            AppType::Hermes => {} // Hermes doesn't support Skills, ignore
        }
    }
...
pub struct McpRoot {
    ...
    /// Hermes MCP 配置（v4.1.0+，实际使用 hermes.json）
    #[serde(default, skip_serializing_if = "McpConfig::is_empty")]
